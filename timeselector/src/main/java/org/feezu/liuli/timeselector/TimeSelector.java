...
public class TimeSelector {
    ...
    private List<LinearLayout> view_showList;
    /**
     * @param context
     ...
     * @param startDate
     * @param endDate
     * @param format_str 自定义formate
     */
    public TimeSelector(Context context,ResultHandler resultHandler,String startDate,String endDate,String format_str){
        this.context = context;
        this.handler = resultHandler;
        startCalendar = Calendar.getInstance();
        endCalendar = Calendar.getInstance();
        this.FORMAT_STR = format_str;
        view_showList = new ArrayList<>();
    ...
    /**
     *
     * @param type  0< type <32 二进制计数 代表要显示的时间
     */
    private void show(int type){
        ...
        for(int i = 4;i>=0;i--){
            if(type % 2 == 0){
                view_showList.get(i).setVisibility(View.GONE);
            }else{
                view_showList.get(i).setVisibility(View.VISIBLE);
            }
            type/=2;
        }
        initParameter();
    ...
    public void show(SHOWTYPE... showtypes){
        int type=0;
    ...
    private void initView() {
        ...
        view_showList.add((LinearLayout) seletorDialog.findViewById(R.id.view_year));
        view_showList.add((LinearLayout) seletorDialog.findViewById(R.id.view_month));
        view_showList.add((LinearLayout) seletorDialog.findViewById(R.id.view_day));
        view_showList.add((LinearLayout) seletorDialog.findViewById(R.id.view_hour));
        view_showList.add((LinearLayout) seletorDialog.findViewById(R.id.view_minute));
